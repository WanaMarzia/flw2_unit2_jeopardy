...
function renderQuestions() {
    for (let i = 0; i < 5; i++) { 
        questionValues = questionValues + (i);
        for (const numbers of questionValues) {
            $("#numberCategories").append("<div class=‘question-column’><div class='question-cell'>"+numbers+"</div></div>"); 
        console.log(numbers);
    }
}}